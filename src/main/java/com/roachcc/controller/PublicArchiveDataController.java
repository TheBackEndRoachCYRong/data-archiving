...
/**
 * 
 * @Description: XX表-归档-控制器
 */
@RestController
@RequestMapping("/archiveData")
@Slf4j
public class PublicArchiveDataController {

    @Autowired
    private ShareDataArchiveService shareDataServiceImpl;
    ...
    public String archiveDataByMonth(@RequestParam("dataMonth") String dataMonth) {
        try {
            ...
            shareDataServiceImpl.archiveData(archiveMonth);
    ...
    public String getStartIdByMonth(@RequestParam("dataMonth") String dataMonth) {
        try {
            ...
            Long startId1 = shareDataServiceImpl.getStartId(dataMonth);
