...
//import com.roachcc.entity.demo.OrderInfo;// TODO 替换为自己的实体类
import java.util.List;

/**
 *
 * @description XX表 的 Mapper
 */
@Mapper
public interface PublicTableInfoMapper extends BaseMapper<Object> { //TODO "Object"替换为自己的实体类
    ...
    Long selectMin(@Param("ew") QueryWrapper<Object> queryWrapper);//TODO “”Object”替换为自己的实体类
}
